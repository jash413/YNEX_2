                ...
                <div className="box kanban-tasks new">
                  <div className="box-body !p-0">
                    <div className="p-4 kanban-board-head">
                      <div className="flex text-[#8c9097] dark:text-white/50 justify-between mb-1 text-[.75rem] font-semibold">
                        <div>
                          <i className="ri-time-line align-middle"></i>Created -
                          30 May
                        </div>
                        <div>2 days left</div>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-secondary/10 text-secondary">
                            Marketing
                          </span>
                          <span className="ms-1 badge bg-warning/10 text-warning">
                            Finance
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-success/10 text-success">
                            Designing
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                      ...
                      <div className="kanban-content mt-2">
                        ...
                        <h6 className="font-semibold mb-0 mt-2 text-[1rem]">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-pink/10">Admin</span>
                    ...
                    <div className="p-3 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-success/10">
                            Planning
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                      ...
                      <div className="kanban-content mt-2">
                        ...
                        <h6 className="font-semibold mb-0 mt-2">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-danger/10 text-danger">
                            Development
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-teal/10 text-teal">
                            Product
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-purple/10 text-purple">
                            Review
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
                    ...
                    <div className="p-4 kanban-board-head">
                      <div className="flex text-[#8c9097] dark:text-white/50 justify-between mb-1 text-[.75rem] font-semibold">
                        ...
                        <div className="text-success">
                          <i className="ri-check-fill me-1 align-middle"></i>
                          Done
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                    ...
                    <div className="p-4 kanban-board-head">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="task-badges">
                          ...
                          <span className="ms-1 badge bg-info/10 text-info">
                            Development
                          </span>
                        </div>
                        <div className="hs-dropdown ti-dropdown ltr:[--placement:bottom-right] rtl:[--placement:bottom-left]">
