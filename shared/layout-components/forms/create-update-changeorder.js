...
const CreateUpdateChangeOrder = (props) => {
  ...
  const updateLocalStorage = async () => {
    await axios
      .get(
        `${network.onlineUrl}api/change_Order?filter[project]=${selectedProject.id}`,
        {
          headers: {
  ...
  const handleInputChange = (event) => {
    ...
    let finalValue;
    if (id === "active" || id === "increaase_budget") {
      finalValue = checked;
    } else if (id === "notes") {
                  ...
                  <div className="box-body">
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="xl:col-span-2 col-span-12">
                        <label htmlFor="increaase_budget" className="form-label">
                          Increase Budget :
                        </label>
                        <br />
                        <input
